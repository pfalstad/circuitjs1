...
export class UIManager {
    ...
    init(): void {
        ...
        this.menus.showOhmCheckItem.setState(showOhm);
        this.menus.showOhmCheckItem.setCommand({
            execute: () => {
                this.setOptionInStorage("showOhm", this.menus.showOhmCheckItem.getState());
            }
        });
