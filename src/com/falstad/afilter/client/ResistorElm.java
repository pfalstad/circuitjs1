...
//import java.util.StringTokenizer;
	...
	void draw(Graphics g) {
	    ...
	    setAdmittanceColor(g, resistance);
...
//		drawThickLine(g, ps1, ps2);
	...
	void calculateCurrent() {
	    ...
	    currenti = (voltsi[0]-voltsi[1])/resistance;
	...
	void getInfo(String arr[]) {
	    ...
	    arr[x++] = "R = " + getUnitText(resistance, sim.ohmString);
	...
	void setResistance(double x) {
	    resistance = x;
	    if (x > 0)
		return;
	    System.out.println("Resistance set to " + x);
	}
	double getValue() { return resistance; }
	void setValue(double x) { setResistance(x); }
    }
