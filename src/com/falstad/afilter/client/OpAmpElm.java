package com.falstad.afilter.client;
	...
	void getInfo(String arr[]) {
	    ...
	    double range = Math.sqrt(volts[2]*volts[2] + voltsi[2]*voltsi[2]);
	    arr[5] = "range = " + getVoltageText(-range) + " to " +
		getVoltageText(range);
	    arr[6] = "GBW = " + getUnitText(gbw, "Hz");
	}
	...
	void stamp() {
	    ...
	    // V2 + gain(V0-V1) = 0
	    double g1 = gain;
	    double g2 = gbw/sim.frequency;
	    if (g2 < g1)
		g1 = g2;
	    sim.stampMatrix(vn, nodes[0], g1);
