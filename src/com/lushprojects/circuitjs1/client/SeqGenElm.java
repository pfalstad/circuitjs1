...
class SeqGenElm extends ChipElm {
	...
	try {
		...
		// The old sequence generator read bytes backwards, from right to left, and this
		...
		data = new int[(bitCount / Integer.SIZE) + (bitCount % Integer.SIZE != 0 ? 1 : 0)]; // Allocate enough
												    // bytes to fit the
												    // requested number
												    // of bits
	...
	// Ensure bitCount does not exceed the amount of data we have. (This can happen
