...
class AudioInputElm extends RailElm {
    ...
    public AudioInputElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
    ...
    String dump() {
	// add a file number to the dump so we can preserve the audio file data when
	// doing cut and paste, or undo/redo.
