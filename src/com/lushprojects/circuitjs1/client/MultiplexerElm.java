...
class MultiplexerElm extends ChipElm {
    ...
    public MultiplexerElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
    ...
    int getPostCount() {
	return outputCount + selectBitCount + 1 + (hasFlag(FLAG_INVERTED_OUTPUT) ? 1 : 0)
		+ (hasFlag(FLAG_STROBE) ? 1 : 0);
    }
