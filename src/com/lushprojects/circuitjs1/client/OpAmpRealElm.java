...
public class OpAmpRealElm extends CompositeElm {
    ...
    private static String model741String = "NTransistorElm 3 8 9\rNTransistorElm 2 8 10\rPTransistorElm 11 12 9\rPTransistorElm 11 13 10\rNTransistorElm 14 12 1\r"
	    + // Q1-5
	    ...
	    + // Q16-22 (no Q18, Q21)
	    "CapacitorElm 13 20\r" + "ResistorElm 15 6\rResistorElm 6 25\r" + // output resistors
    ...
    private static String lm324ModelString = "TransistorElm 1 2 3\rCurrentElm 4 3\rTransistorElm 2 2 5\rTransistorElm 2 6 5\rCapacitorElm 6 7\rCurrentElm 4 8\rCurrentElm 4 7\rTransistorElm 8 4 9\r"
    ...
    private static String lm324ModelDump = "0 -1 -0 0 10000/0 0.000006/0 1 0 0 100/0 1 0 0 100/0 1e-11 0/0 0.000004/0 0.0001/0 1 0 0 100/0 1 0 0 100/0 1 0 0 100/0 1 0 0 100/0 25/0 -1 0 0 100/0 0.00005/"
	    + "0 -1 0 0 100/0 10000/0 1 0 0 100/0 -1 0 0 10000";

    // from LM324 spice model, ON SEMICONDUCTOR NEXT GEN MODEL 9/27/2018
    private static String lm324v2ModelString = "ResistorElm 4 6\rCurrentElm 4 7\rResistorElm 4 29\rResistorElm 8 30\rResistorElm 9 31\rTransistorElm 30 29 31 \rResistorElm 4 32\rResistorElm 2 33\rResistorElm 10 34\r"
    ...
    private static String lm324v2ModelDump = "0 40000/0 5e-7/0 380/0 1700/0 5/0 -1 0 0 306 xlm324v2-qpi/0 380/0 1700/0 5/0 -1 0 0 300 xlm324v2-qpa/0 380/0 1700/0 5/0 -1 0 0 306 xlm324v2-qpi/0 380/0 1700/0 5/"
	...
	// adjust output stage resistor values and transistor betas to increase current
	// if desired
	...
	// these two segments may not be an event multiple of gridSize so we draw them
	// the other way so the dots line up
