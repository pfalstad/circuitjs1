...
class TappedTransformerElm extends CircuitElm {
	...
	try {
	    current[2] = Double.valueOf(st.nextToken()).doubleValue();
	} catch (Exception e) {
	}
	couplingCoef = .99;
	try {
    ...
    void reset() {
	current[0] = current[1] = current[2] = current[3] = volts[0] = volts[1] = volts[2] = volts[3] = volts[4] = curcount[0] = curcount[1] = curcount[2] = 0;
