...
public class OhmMeterElm extends CurrentElm {
    ...
    public OhmMeterElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
    ...
    /*
     * public EditInfo getEditInfo(int n) { if (n == 0) return new
     * EditInfo("Current (A)", currentValue, 0, .1); return null; } public void
     * setEditValue(int n, EditInfo ei) { currentValue = ei.value; }
     */
