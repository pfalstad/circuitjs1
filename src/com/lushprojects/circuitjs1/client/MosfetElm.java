...
class MosfetElm extends CircuitElm {
	...
	allocNodes(); // make sure volts[] has the right number of elements when hasBodyTerminal() is
		      // true
    }
    ...
    double getPower() {
	return ids * (volts[2] - volts[1]) - diodeCurrent1 * (volts[1] - volts[bodyTerminal])
