...
class SevenSegDecoderElm extends ChipElm {
    ...
    private static final boolean[][] symbols = { { true, true, true, true, true, true, false }, // 0
    ...
    public SevenSegDecoderElm(int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
